...
var Config = (function () {
    function Config() {
        ...
        this.forgotPasswordEmail = function (body) {
            return {
                from: 'jakejinspark@gmail.com',
                to: body.email,
                subject: 'Grace Digital Service Parts Warehouse Password Reset Request',
        ...
        this.resetPasswordEmail = function (body) {
            return {
                from: 'jakejinspark@gmail.com',
                to: body.email,
                subject: 'Grace Digital Service Parts Warehouse Password Changed',
                text: 'Hello,\n\n' +
        ...
        this.orderPlacedEmail = function (body) {
            return {
                from: 'GDS <jakejinspark@gmail.com>',
                to: body.to,
